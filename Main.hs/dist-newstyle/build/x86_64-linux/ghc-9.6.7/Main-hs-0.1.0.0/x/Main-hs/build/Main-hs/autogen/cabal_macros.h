...
/* package Main-hs-0.1.0.0 */
#ifndef VERSION_Main_hs
#define VERSION_Main_hs "0.1.0.0"
#endif /* VERSION_Main_hs */
#ifndef MIN_VERSION_Main_hs
#define MIN_VERSION_Main_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Main_hs */
...
#define CURRENT_COMPONENT_ID "Main-hs-0.1.0.0-inplace-Main-hs"
